...
import { FaChalkboardTeacher, FaBookOpen, FaCheckCircle, FaStar, FaShieldAlt, FaEnvelope, FaLock } from "react-icons/fa";
  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-6xl mx-auto flex flex-row-reverse items-center justify-between pt-8 pb-4 px-2 md:px-0">
        <a href="/" className="text-primary text-base font-medium flex items-center gap-1 hover:underline">
      ...
      <div className="w-full max-w-6xl mx-auto flex flex-col md:flex-row-reverse items-center justify-center gap-8 md:gap-16 flex-1 min-h-[calc(100vh-120px)]">
        <div className="flex-1 max-w-md bg-white rounded-2xl shadow-xl p-8 mt-4 mb-8 md:mb-0 md:mt-0">
          <h2 className="text-2xl font-bold mb-1 text-center text-gray-800">تسجيل الدخول</h2>
          ...
          <div className="flex mb-6 gap-2 rounded-lg bg-gray-100 p-1">
            <button
              type="button"
              className={`flex-1 py-2 rounded-lg text-lg font-medium transition-all flex items-center justify-center gap-2 border ${role === "teacher" ? "bg-white text-primary border-primary shadow" : "bg-gray-100 text-gray-400 border-transparent"}`}
            ...
            <button
              type="button"
              className={`flex-1 py-2 rounded-lg text-lg font-medium transition-all flex items-center justify-center gap-2 border ${role === "student" ? "bg-white text-primary border-primary shadow" : "bg-gray-100 text-gray-400 border-transparent"}`}
        ...
        <div className="flex-1 flex items-center justify-right bg-transparent">
          <div className="max-w-md text-center md:text-right w-full">
            <div className="mb-8">
            <h1 className="text-6xl font-bold mb-6 flex items-end justify-center gap-4">
              <span className="text-[#374151] font-bold">أهلاً بعودتك الى</span>
              ...
              <p className="text-gray-500 text-lg font-medium mb-8 mt-2 text-center md:text-right">استكمل رحلتك التعليمية في تعلم العربية والقرآن الكريم.</p>
            </div>
            <ul className="space-y-6 mb-10 w-full">
              <li className="flex items-center justify-start text-gray-700 text-xl font-medium">
            ...
            <div className="text-lg text-gray-700 text-center md:text-right">
              ليس لديك حساب؟
              <a href="/signup" className="text-primary font-extrabold hover:underline mr-4">إنشاء حساب جديد</a>
            </div>
          </div>
        </div>
      </div>
